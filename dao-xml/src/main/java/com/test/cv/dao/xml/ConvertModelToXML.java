...
import com.test.cv.xml.EducationType;
import com.test.cv.xml.ExitReasonType;
import com.test.cv.xml.ItemType;
import com.test.cv.xml.ItemsType;
...
import com.test.cv.xml.ProjectType;
import com.test.cv.xml.SelfEmployedType;
import com.test.cv.xml.SkillCategoriesType;
...
import com.test.cv.xml.SkillsAquiringItemType;
import com.test.cv.xml.SkillsType;
