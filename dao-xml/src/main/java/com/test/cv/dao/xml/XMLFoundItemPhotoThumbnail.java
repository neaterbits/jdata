...
final class XMLFoundItemPhotoThumbnail extends BaseFoundItemPhotoThumbnail implements IFoundItemPhotoThumbnail {
	...
	public XMLFoundItemPhotoThumbnail(String id, String itemId, int index, String mimeType, List<ItemPhotoCategory> categories, byte[] data) {
		super(id, itemId, index, mimeType, categories, data);
	}
}
